    ...
    <main className="bh-auth-page">
      <section className="bh-auth-panel" aria-labelledby="onboarding-title">
        ...
        <form action={submitOnboarding} className="bh-auth-form">
          ...
          <input id="organizationSlug" name="organizationSlug" defaultValue="bighead" pattern="[a-z0-9][a-z0-9\-]{1,62}" title="Use apenas letras minusculas, numeros e hifens" required />
